...
const s_dstStart = ['March', 'Sunday', 9, 2]; // Example shown is the second Sunday of March at 2:00 am
const s_dstEnd = ['November', 'Sunday', 2, 2]; // Example shown is the first Sunday of November at 2:00 am
